...
export default function AdminSLTUser() {
  ...
  //           alert(`Selected Customer Admin is deleted !!!`)
  //           // setSuccessMessage(`Customer Admin user is deleted !!!`);
  //           // setTimeout(() => {
  //           //   setSuccessMessage("");
  //           // }, 2000);
      ...
      >
        ...
        <Paper
          ...
          sx={{
            ...
            marginLeft: { xs: "0px", sm: "110px", md: "80px", lg: "70px" },
          ...
          {isDesktop ? (
            ...
            >
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ fontWeight: "bold",padding:1 }}>Profile Pic</TableCell>
                    <TableCell sx={{ fontWeight: "bold" ,padding:1}}>User ID</TableCell>
                ...
                <TableBody>
                  {paginatedUsers.map((user) => (
                    ...
                    >
                      ...
                      <TableCell sx={{ padding:1 }}>{"UID"+user.id}</TableCell>
