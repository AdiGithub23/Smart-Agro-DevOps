...
import DivisionSelectionCA from "../../Components/DivisionSelectionCA";
...
export default function AdminSLTDistrictSelection() {
  ...
  const handleItemClick = (district) => {
    ...
    if (!isDesktop) {
      setOpenModal(true); // Open modal on non-desktop views
    }
  };
      ...
      >
        ...
        <Paper
          ...
          sx={{
            ...
            marginLeft: { xs: "10px", sm: "180px", md: "200px", lg: "250px" },
            marginTop: { xs: "145px", sm: "145px", md: "140px", lg: "100px" },
            position: "relative",
            display: "flex",
        ...
        {!isDesktop && selectedDistrict && (
          ...
          >
            ...
            >
              <DivisionSelectionCA districtName={selectedDistrict} />
            </Box>
          </Modal>
        )}
