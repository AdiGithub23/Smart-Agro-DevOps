...
import DeviceModal from "./DeviceManagerModal";
...
export default function ManagerYield() {
    ...
    <div style={backgroundStyle}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={4}>
            <Button
              ...
              color="success"
              sx={{
                marginLeft: { xs: 18, sm: 24, md: 25, lg: 40 },
                height: "50px",
              }}
          ...
          <Grid item xs={6} sm={2}>
            <TextField
              ...
              sx={{
                mx: 2,
                marginLeft: { xs: 0, sm: 8, md: 2, lg: 10 },
                "& .MuiInputBase-root": {
                  "&:after": {
                    borderBottomColor: "green",
                  },
      ...
      <Tooltip title="Add or Manage Devices">
        <Fab
          ...
          sx={{
            position: "absolute",
            right: { xs: 18, sm: 23, md: 10, lg: 40 },
            top: { xs: 100, sm: 90, md: 100, lg: 95 },
          }}
        >
          <AddIcon />
        </Fab>
      ...
      <ScrollContainer
        sx={{ mt: 1, mr: 1, ml: { xs: 0, sm: 23, md: 21, lg: 30 } }}
      >
